				...
				<Aux>
					...
					<div className="row margin-0">
						<div className="col-xl-12">
					      ...
					      <div className="card-header" style={{ background: '#06151E', paddingBottom: 0, fontSize: '20px', fontWeight: '900', border:'0' }}>
					      ...
					      <div className="card-body padding-bottom-0" style={{ background: '#06151E' }}>
					        <MovieContainer showTotal={6} hidePagination={true} isUpcoming={true}/>
					      </div>
					    </div>
			        <div className="card">
			          <div className="card-header" style={{ background: '#06151E', paddingBottom: 0, fontSize: '20px', fontWeight: '900' }}>
			            <ul className="list-inline margin-bottom-0">
