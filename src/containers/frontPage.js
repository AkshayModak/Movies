			        ...
			        <div className="card">
			          <div className="card-header" style={{ background: 'black', paddingBottom: 0, fontSize: '20px', fontWeight: '900' }}>
			            <ul className="list-inline margin-bottom-0">
			              ...
			              <li className="list-inline-item float-right"><Link to="/in-theatre" className="btn btn-light float-right">View All</Link></li>
			            </ul>
			          </div>
			          <div className="card-body padding-bottom-0" style={{ background: 'black' }}>
			        ...
			        <div className="card">
			          <div className="card-header" style={{ background: 'black', paddingBottom: 0, fontSize: '20px', fontWeight: '900' }}>
			            <ul className="list-inline margin-bottom-0">
			              ...
			              <li className="list-inline-item float-right"><Link to="/popular-tv" className="btn btn-light float-right">View All</Link></li>
			            </ul>
			          </div>
			          <div className="card-body padding-bottom-0" style={{ background: 'black' }}>
